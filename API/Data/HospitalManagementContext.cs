...
namespace HospitalManagement.Data
{
    public class HospitalManagementContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Patient>().HasOne(a => a.Title).WithMany(b => b.PatientInfo).HasForeignKey(c => c.TitleId);
            modelBuilder.Entity<Patient>().HasOne(a => a.Gender).WithMany(b => b.PatientInfo).HasForeignKey(c => c.GenderId);
            modelBuilder.Entity<Patient>().HasOne(a => a.Address).WithMany(b => b.PatientInfo).HasForeignKey(c => c.AddressId);
            modelBuilder.Entity<Patient>().HasOne(a => a.Location).WithMany(b => b.PatientInfo).HasForeignKey(c => c.LocationId);
            modelBuilder.Entity<Patient>().HasOne(a => a.Membership).WithMany(b => b.PatientInfo).HasForeignKey(c => c.MembershipId);
            modelBuilder.Entity<Address>().HasOne(a => a.Country).WithMany(b => b.AddressInfo).HasForeignKey(c => c.CountryId);
            modelBuilder.Entity<Country>().HasOne(a => a.Currency).WithMany(b => b.CountryInfo).HasForeignKey(c => c.CurrencyId);
            modelBuilder.Entity<Country>().HasOne(a => a.Language).WithMany(b => b.CountryInfo).HasForeignKey(c => c.LanguageId);
            modelBuilder.Entity<Location>().HasOne(a => a.Country).WithMany(b => b.LocationInfo).HasForeignKey(c => c.CountryId);
        }
